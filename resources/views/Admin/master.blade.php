...
<!-- Mirrored from codervent.com/skodash/demo/tabular-menu/ltr/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Aug 2022 05:34:56 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{asset('/')}}assets/npm/bootstrap-icons%401.5.0/font/bootstrap-icons.css">
                    ...
                    <li class="nav-item dropdown dropdown-large">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                            <div class="user-setting d-flex align-items-center gap-1">
                                ...
                                <div class="user-name d-none d-sm-block">Shaoun</div>
                            </div>
                        </a>
                            ...
                            <li>
                                <a class="dropdown-item" href="#">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h6 class="mb-0 dropdown-user-name">Shaoun</h6>
                                            <small class="mb-0 dropdown-user-designation text-secondary">Admin Manager</small>
                                        </div>
                                    </div>
                                </a>
                            </li>
    ...
    <aside class="sidebar-wrapper">
        <div class="iconmenu">
            ...
            <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="SubCategory">
                    <button class="nav-link" data-bs-toggle="pill" data-bs-target="#pills-widgets" type="button"><i class="bi bi-briefcase-fill"></i></button>
                </li>
                <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Brand">
                ...
                <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Unit">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="pills-widgets">
                    <div class="list-group list-group-flush">
                        <div class="list-group-item">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-0">SubCategory Module</h5>
                            </div>
                            <small class="mb-0">Some placeholder content</small>
                        </div>
                        <a href="{{route('add-subcategory')}}" class="list-group-item"><i class="bi bi-box"></i>Add SubCategory</a>
                        <a href="{{route('manage-subcategory')}}" class="list-group-item"><i class="bi bi-bar-chart"></i>Manage SubCategory</a>
                    </div>
                </div>
                <div class="tab-pane fade" id="pills-ecommerce">
                    <div class="list-group list-group-flush">
                        <div class="list-group-item">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-0">Brand Module</h5>
                            </div>
                            <small class="mb-0">Some placeholder content</small>
                        </div>
                        <a href="{{route('add-brand')}}" class="list-group-item"><i class="bi bi-box-seam"></i>Add Brand</a>
                        <a href="{{route('manage-brand')}}" class="list-group-item"><i class="bi bi-box-seam"></i>Manage Brand</a>
                    </div>
                </div>
                <div class="tab-pane fade" id="pills-components">
                    <div class="list-group list-group-flush">
                        <div class="list-group-item">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-0">Unit Module</h5>
                            </div>
                            <small class="mb-0">Some placeholder content</small>
                        </div>
                        <a href="{{route('add-unit')}}" class="list-group-item"><i class="bi bi-bell"></i>Add Unit</a>
                        <a href="{{route('manage-unit')}}" class="list-group-item"><i class="bi bi-arrows-collapse"></i>Manage Unit</a>
                    </div>
                </div>
                <div class="tab-pane fade" id="pills-authentication">
                    <div class="list-group list-group-flush">
                        <div class="list-group-item">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-0">Product Module</h5>
                            </div>
                            <small class="mb-0">Some placeholder content</small>
                        </div>
                        <a href="{{route('add-product')}}" class="list-group-item"><i class="bi bi-easel"></i>Add Product</a>
                        <a href="{{route('manage-product')}}" class="list-group-item"><i class="bi bi-emoji-heart-eyes"></i>Manage Product</a>
                    </div>
                </div>
                <div class="tab-pane fade" id="pills-icons">
                    <div class="list-group list-group-flush">
                        <div class="list-group-item">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-0">Order Module</h5>
                            </div>
                            <small class="mb-0">Some placeholder content</small>
                        </div>
                        <a href="{{route('manage-order')}}" class="list-group-item"><i class="bi bi-brightness-low"></i>Manage Order</a>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="pills-pages">
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{route('manage-user')}}" class="list-group-item"><i class="bi bi-archive"></i>Manage User</a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from codervent.com/skodash/demo/tabular-menu/ltr/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Aug 2022 05:36:19 GMT -->
</html>
